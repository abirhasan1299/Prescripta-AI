...
<div class="wrapper">
    ...
    <div class="sidenav-menu">
        ...
        <div class="scrollbar" data-simplebar="">
            ...
            <div id="sidenav-menu">
                <ul class="side-nav">
                    <li class="side-nav-title mt-2" data-lang="main">Medicines</li>
                    <li class="side-nav-item">
                        <a  href="{{route('drug')}}" class="side-nav-link">
                            <span class="menu-icon"><i class="ti ti-capsule"></i></span>
                            <span class="menu-text" data-lang="dashboards">Drugs</span>
                        </a>
                    </li>
                    <li class="side-nav-item">
                        <a  href="{{route('generic')}}" class="side-nav-link">
                            <span class="menu-icon"><i class="ti ti-capsule"></i></span>
                            <span class="menu-text" data-lang="dashboards">Generics</span>
                        </a>
                    </li>
                </ul>
            </div>
